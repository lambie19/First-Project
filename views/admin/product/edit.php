<div class="container-fluid">
    ...
    <?php
    // Nếu có dữ liệu cũ (khi validate lỗi) thì dùng, không thì dùng dữ liệu từ DB
                            ...
                            <div class="col-8">
                                <select class="form-select" name="category_id" id="category_id">
                                    <?php foreach ($categories as $cat): ?>
                                        <?php
                                        $selectedCatId = $old['category_id'] ?? $product['category_id'];
                                        ?>
                                        <option value="<?= $cat['id'] ?>"
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="description" id="description" rows="5"><?= htmlspecialchars($old['description'] ?? $product['description']) ?></textarea>
                        </div>
                    </div>
                </div>
