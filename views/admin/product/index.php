<a href="<?= BASE_URL_ADMIN .'&action=create-product' ?>" class="btn btn-primary">Taọ mới</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                 ...
                 onclick="return confirm('Có chắc chắn muốn xóa không');" class="btn btn-danger">Xóa</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
